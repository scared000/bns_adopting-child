...
class AdoptedChildForm
{
    ...
    public static function afterCreate($record, array $data): void
    {
        ...
        $record->familyStatus()->create([
            ...
            'phil_member' => $data['phil_member'] == 'yes',
            'family_plan_method' => $data['family_plan_method'],
            'have_electricity' => $data['have_electricity'] == 'yes',
    ...
    public static function fillEditForm($record): array
    {
        ...
        return [
            ...
            'phil_member' => $status ? ($status->phil_member ? 'yes' : 'no') : null,
            'family_plan_method' => $status?->family_plan_method,
            'have_electricity' => $status ? ($status->have_electricity ? 'yes' : 'no') : null,
